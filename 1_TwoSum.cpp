...
public:
    vector<int> twoSum(vector<int>& nums, int target) 
    {
        ...
        for(int i = 0; i < nums.size(); i++)
        {
            ...
            {   
                // not found in the unordered_mapas the identifier returned by the mp.find() function travesres till the end and finally points beyond the last element of the container.
